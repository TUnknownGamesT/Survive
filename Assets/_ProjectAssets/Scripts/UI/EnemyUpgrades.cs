...
public class EnemyUpgrades : MonoBehaviour
{
    ...
    [Header("References")] public TextMeshProUGUI upgradeText;
    public Image mainImage;

    [Header("Items Images")] public Sprite speedImage;
    public Sprite healthImage;
    public Sprite damageImage;

    [Header("Upgrades")] public float speedUpgrade;
